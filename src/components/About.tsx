      ...
      <div className="flex flex-col lg:flex-row items-center gap-12">
        ...
        >
          ...
          <p className="text-gray-600 dark:text-gray-300 mb-6 text-lg leading-relaxed">
            Passionné par la transformation des données en valeur actionnable, je suis un <span className="font-semibold text-gray-800 dark:text-gray-100">Data Engineer</span> et <span className="font-semibold text-emerald-600 dark:text-emerald-400">Automation & IA Engineer</span>.
          </p>
